...
const SingAlong = () => {
  const songs = [
    { title: "Let It Go", emoji: "âï¸", lyrics: ["Let it go, let it go!", "Can't hold it back anymore!"] },
    { title: "Under the Sea", emoji: "ð ", lyrics: ["Under the sea!", "Darling it's better, down where it's wetter!"] },
    { title: "A Whole New World", emoji: "ð§", lyrics: ["A whole new world!", "A new fantastic point of view!"] },
  ];
    ...
    <GameLayout title="Sing-Along! ð¤">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        {songs[currentSong].lyrics.map((line, i) => (
          <p key={i} className="text-2xl mb-2">ðµ {line}</p>
        ))}
