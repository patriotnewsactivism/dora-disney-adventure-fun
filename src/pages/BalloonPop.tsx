...
const BalloonPop = () => {
  ...
  const balloonTypes = [
    { type: "normal", emoji: "🎈", color: "text-red-500", points: 1 },
    { type: "normal", emoji: "🎈", color: "text-blue-500", points: 1 },
    { type: "normal", emoji: "🎈", color: "text-green-500", points: 1 },
    { type: "normal", emoji: "🎈", color: "text-yellow-500", points: 1 },
    { type: "special", emoji: "⭐", color: "text-yellow-400", points: 5 },
    { type: "heart", emoji: "❤️", color: "text-pink-500", points: 3 },
  ];
    ...
    <GameLayout title="Balloon Pop! 🎈">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative h-[600px] bg-gradient-to-b from-sky-200 to-sky-400 rounded-2xl border-4 border-primary overflow-hidden">
          {/* Clouds */}
          <div className="absolute top-4 left-1/4 text-6xl opacity-70">☁️</div>
          <div className="absolute top-20 right-1/4 text-6xl opacity-70">☁️</div>
          <div className="absolute top-40 left-1/2 text-6xl opacity-70">☁️</div>
